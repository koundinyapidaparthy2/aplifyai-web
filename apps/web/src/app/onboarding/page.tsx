...
export default function OnboardingPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
            ...
            {/* AI Assistant - Always visible during onboarding */}
            {currentStep !== 'complete' && (
                <div className="fixed bottom-4 right-4 w-80 z-50">
                    <AIAssistantChat
                        context="onboarding"
                        userProfile={profileData}
                        initialMessage="I can help you create an impressive profile. Try asking me to:"
                        onSuggestionApply={(suggestion) => {
                            if (suggestion.data?.field === 'summary') {
                                setProfileData(prev => ({ ...prev, summary: suggestion.text }));
                            } else if (suggestion.data?.field === 'skills') {
